export default {
  ...
  'demuxed': '#EXTM3U\n' +
    '#EXT-X-VERSION:4\n' +
    '#EXT-X-MEDIA:TYPE=AUDIO,GROUP-ID="audio",NAME="en",DEFAULT=YES,AUTOSELECT=YES,LANGUAGE="en",URI="audio.m3u8"\n' +
  ...
  'manifestNoExtM3u': '#ZEN-TOTAL-DURATION:10\n' +
    ...
    '#EXT-X-ENDLIST\n' +
    '\n',
  'master-captions': '# A simple master playlist with multiple variant streams\n' +
    '#EXTM3U\n' +
    '\n' +
